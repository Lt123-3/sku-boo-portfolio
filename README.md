...
parts — so whoever's already at the packing desk can check in seconds, no handoff and no browser
required. It went from idea to deployed hardware in about a week, ran for roughly two weeks, and
